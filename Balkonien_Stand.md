...
- v15 gebaut (`index.html` + `Balkonien_v15.html`).
...
- Offene Frage an Klaus: Sollen die kleinen Emoji-Symbole auf der Website bleiben oder entfernt werden?
- Bei weiteren Pflanzen: Eintrag in `plants.json`, dann `python3 build.py --version 16`.
